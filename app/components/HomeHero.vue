  ...
  <StyleMount class="HomeHero u-wrapper">
    <div class="u-relative u-container">
      <div class="content">
        <i18n
          tag="h1"
          path="components.HomeHero.title"
          class="title"
        >
          <template #newline>
            <br>
          ...
          <template #welcome>
            {{ $t('components.HomeHero.welcome') }}
          </template>
          <template #japan>
            {{ $t('components.HomeHero.japan') }}
          </template>
          <template #community>
            {{ $t('components.HomeHero.community') }}
          </template>
        </i18n>
        <i18n
          tag="p"
          path="components.HomeHero.text"
          class="text"
        >
          <template #newline>
            <br>
      ...
      <div class="image">
        <div class="image-container">
          <figure class="image-figure">
            <img
              class="image-src"
              src="/img/home/tokyo-tower-with-sun.png"
              alt="Tokyo tower with sun"
            >
          </figure>
        </div>
      </div>
...
.HomeHero.mount-active {
  ...
  .marker {
    transition: background-size 1s var(--ease-out-quint);
  }
  ...
  .marker-1 { transition-delay: 0.8s; }
  .marker-2 { transition-delay: 0.9s; }
...
.marker {
  position: relative;
  background: linear-gradient(var(--c-vue-green-lighter), var(--c-vue-green-lighter));
