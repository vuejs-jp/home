<template>
  <StyleMount class="HomeSponsors u-wrapper" tag="section">
    <div class="u-container">
      ...
      <ul class="sponsors">
        <li class="sponsor">
          <a class="sponsor-link" href="https://docs.esa.io/posts/239/" target="_blank">
            <img class="sponsor-logo" src="/img/common/logo-esa.png" alt="esa">
          </a>
        </li>
        <li class="sponsor">
          <a class="sponsor-link" href="https://slack.com" target="_blank">
            <img class="sponsor-logo" src="/img/common/logo-slack.png" alt="Slack">
          </a>
        </li>
      </ul>
    </div>
